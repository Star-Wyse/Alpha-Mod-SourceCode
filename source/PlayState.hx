			...
			case 'cliff':
				{
						...
						var hills:FlxSprite = new FlxSprite(-320, 0).loadGraphic(Paths.image('alpha stage/background'));
						hills.antialiasing = true;
						hills.scrollFactor.set(1, 1.2);
						hills.active = false;
						add(hills);
	
						var bushes:FlxSprite = new FlxSprite(-320, 0).loadGraphic(Paths.image('alpha stage/middleground'));
						bushes.updateHitbox();
						bushes.antialiasing = true;
						bushes.scrollFactor.set(1, 1.1);
						bushes.active = false;
						add(bushes);
	
						var ground:FlxSprite = new FlxSprite(-320, 0).loadGraphic(Paths.image('alpha stage/foreground'));
						ground.updateHitbox();
